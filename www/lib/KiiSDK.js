    ...
    memberCallbacks = {
      success: (function(_this) {
        return function(data, statusCode) {
          ...
          return _thisGroup._saveMembers(callback);
        };
      })(this),
      failure: (function(_this) {
        return function(error, statusCode) {
          ...
          return callback.failure(_thisGroup, error, addMembersArray, removeMembersArray);
        };
      })(this)
    };
        ...
        failure: (function(_this) {
          return function(error, statusCode) {
            ...
            if (callbacks != null) {
              ...
              return callbacks.failure(_thisGroup, error, addMembersArray, removeMembersArray);
            }
          };
        })(this)
      };
...
root.KiiObject = (function() {
  var _bodyContentType, _bucket, _created, _customInfo, _modified, _objectType, _owner, _thisObject, _uuid;
  ...
  KiiObject.prototype.uploadBody = function(srcDataBlob, callbacks) {
    ...
    if (!srcDataBlob || !(srcDataBlob instanceof Blob)) {
      callbacks.failure(_thisObject, "Invalid parameter");
      return;
    }
    _thisObject = this;
    ...
    requestCallback = {
      success: (function(_this) {
        return function() {
          ...
          if (statusCode < 300 && statusCode >= 200 && (callbacks != null)) {
            _thisObject._setBodyContentType(contentType);
            return callbacks.success(_thisObject);
          } else if (callbacks != null) {
            return callbacks.failure(_thisObject, "Unable to parse response");
          }
      ...
      failure: (function(_this) {
        return function() {
          ...
          if (callbacks != null) {
            return callbacks.failure(_thisObject, errString);
          }
        };
      })(this),
    ...
    requestCallback = {
      success: (function(_this) {
        return function() {
          ...
          statusCode = xhr.status;
          if (statusCode < 300 && statusCode >= 200 && (callbacks != null)) {
            _thisObject._setBodyContentType(xhr.getResponseHeader('content-type'));
            if (callbacks != null) {
              return callbacks.success(_thisObject, xhr.response);
            }
          } else if (callbacks != null) {
            return callbacks.failure(_thisObject, "Unable to parse response");
          }
      ...
      failure: (function(_this) {
        return function() {
          var fileReader, responseText;
          root.Kii.logger("Failure...");
          ...
          fileReader.onload = function() {
            ...
            if (callbacks != null) {
              callbacks.failure(_thisObject, errString);
            }
          };
  ...
  KiiObject.prototype.publishBody = function(callbacks) {
    var path, publishBodyCallbacks, request;
    _thisObject = this;
    path = this._getPath() + "/body/publish";
    request = new this._getRequest({
      path: path,
      withApp: true
    });
    ...
    publishBodyCallbacks = {
      success: (function(_this) {
        return function(data, statusCode) {
          if (statusCode < 300 && statusCode >= 200 && (callbacks != null)) {
            return callbacks.success(_thisObject, data.url);
          } else if (callbacks != null) {
            return callbacks.failure(_thisObject, "Unable to parse response");
          }
        };
    ...
    return request.execute(publishBodyCallbacks, false);
  };
  ...
  KiiObject.prototype.publishBodyExpiresAt = function(expiresAt, callbacks) {
    var path, publishBodyCallbacks, request, requestBody;
    _thisObject = this;
    path = this._getPath() + "/body/publish";
    request = new this._getRequest({
      path: path,
  ...
  KiiObject.prototype.deleteBody = function(callbacks) {
    ...
    refreshCallbacks = {
      success: (function(_this) {
        return function(data, statusCode) {
          if (statusCode < 300 && statusCode >= 200 && (callbacks != null)) {
            _thisObject._setBodyContentType(null);
            return callbacks.success(_thisObject);
          } else if (callbacks != null) {
            return callbacks.failure(_thisObject, "Unable to parse response");
          }
...
KiiXHRWrapper = (function() {
  KiiXHRWrapper.xhr = null;

  KiiXHRWrapper.method = null;
